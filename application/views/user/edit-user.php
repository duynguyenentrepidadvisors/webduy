...
<body>
  <div class="login">
   ...
   <input type="text" id="name" name="name" value="<?php echo $user["name"] ?>" placeholder="username" required>
   ...
   <input type="text" id="firstName" value="<?php echo $user["firstName"] ?>" name="firstName" placeholder="First Name" required  /> 
   <span id="aler-firstname" class=" text-danger"></span>

   <input type="text" id="lastName" value="<?php echo $user["lastName"] ?>" name="lastName" placeholder="Last Name" required  /> 
